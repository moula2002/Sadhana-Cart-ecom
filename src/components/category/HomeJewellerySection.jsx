...
// 🎨 STYLE CONSTANTS (Maroon/Gold Theme with Dark Mode)
const PRIMARY_TEXT_COLOR = "#2d2d2d";
const PRIMARY_TEXT_COLOR_DARK = "#e9ecef";
const ACCENT_COLOR = "#800020"; // Classic Maroon
const ACCENT_COLOR_DARK = "#9a2440"; // Brighter maroon for dark mode
const GOLD_COLOR = "#D4AF37"; // Gold accent
const GOLD_COLOR_DARK = "#E6C158"; // Brighter gold for dark mode
const SALE_COLOR = "#B8860B"; // Dark Goldenrod
const SALE_COLOR_DARK = "#D4A017"; // Brighter for dark mode
const WHITE_COLOR = "#FFFFFF";
const PRODUCT_BG_COLOR = "#fdf6f6"; // Very light maroon/pink for cards
const PRODUCT_BG_COLOR_DARK = "#1a1a1a"; // Dark mode card background
const MAROON_BG_GRADIENT = "linear-gradient(135deg, #fdf6f6 0%, #f5e6e8 100%)";
...
const getCustomStyles = (isDarkMode) => ({
  ...
  productCard: {
    ...
    boxShadow: isDarkMode
      ...
      : "0 10px 25px rgba(128, 0, 32, 0.05)",
  ...
  imageContainer: (isMobile) => ({
    ...
    backgroundColor: isDarkMode ? "#2d2d2d" : PRODUCT_BG_COLOR,
    padding: "10px",
  }),
  productImage: {
    maxWidth: "100%",
  ...
  discountBadge: {
    ...
    top: "12px",
    right: "12px",
    backgroundColor: isDarkMode ? GOLD_COLOR_DARK : GOLD_COLOR,
    color: isDarkMode ? PRIMARY_TEXT_COLOR_DARK : "#2d2d2d",
  ...
  brandText: {
    fontSize: "0.7rem",
    fontWeight: "700",
    color: isDarkMode ? GOLD_COLOR_DARK : "#8B4513", // Saddle Brown
    marginBottom: "4px",
    letterSpacing: "1px",
  ...
  price: {
    fontSize: "1.35rem",
    fontWeight: "900",
    color: isDarkMode ? GOLD_COLOR_DARK : GOLD_COLOR,
    letterSpacing: "-0.5px",
  },
  originalPrice: {
    fontSize: "0.85rem",
  ...
  viewDealButtonHover: (isDarkMode) => ({
    backgroundColor: isDarkMode ? GOLD_COLOR_DARK : GOLD_COLOR,
    borderColor: isDarkMode ? GOLD_COLOR_DARK : GOLD_COLOR,
    color: isDarkMode ? PRIMARY_TEXT_COLOR_DARK : WHITE_COLOR,
  ...
  exploreButton: {
    ...
    boxShadow: isDarkMode
      ...
      : "0 10px 30px rgba(128, 0, 32, 0.15)",
  },
...
const handleCardMouseEnter = (e, isDarkMode) => {
  ...
  e.currentTarget.style.boxShadow = isDarkMode
    ...
    : "0 25px 50px rgba(128, 0, 32, 0.12)";
...
const handleViewDealMouseEnter = (e, isDarkMode, customStyles) =>
  Object.assign(
    ...
    customStyles.viewDealButtonHover(isDarkMode)
  );
...
const handleExploreMouseEnter = (e, isDarkMode, customStyles) =>
  Object.assign(
    e.currentTarget.style,
    customStyles.exploreButtonHover(isDarkMode)
  );
...
const getProductImageSource = (product) => {
  ...
  return "https://placehold.co/300x380/fdf6f6/800020?text=JEWELLERY";
};
...
const generateDummyProduct = (index) => {
  ...
  return {
    id: `jewellery-gold-${index}`,
    name: `Elegant ${jewelleryTypes[index % jewelleryTypes.length]} ${index + 1}`,
    brand: "ROYAL JEWELS",
    price: finalPrice,
    originalPrice,
    image: `https://picsum.photos/seed/jewellery${index}/300/300`,
  };
};
...
function HomeJewellerySection() {
  ...
  useEffect(() => {
    const fetchJewellery = async () => {
      setLoading(true);
      try {
        const cached = localStorage.getItem("jewelleryProductsMaroon");
        if (cached) {
        ...
        let data = snapshot.docs.map((doc) => ({
          id: doc.id,
          ...doc.data(),
          price: doc.data().price ? Number(doc.data().price) : 4999,
  ...
  return (
    <Container
      fluid
      className="category-section jewellery"
      style={{
        background: isDarkMode ? DARK_BG_GRADIENT : MAROON_BG_GRADIENT,
        padding: "70px 0",
    ...
    >
      <Container
        ...
        className="jewellery-section-container"
      >
        ...
        {loading ? (
          ...
          <>
            <Row
              ...
              md={3}
              lg={4}
              className="g-3 g-lg-4 justify-content-center"
            >
                  ...
                  <Col key={product.id}>
                    ...
                    >
                      <Card
                        ...
                        className="jewellery-card theme-card"
                        onMouseEnter={(e) => handleCardMouseEnter(e, isDarkMode)}
                        onMouseLeave={(e) =>
                          handleCardMouseLeave(e, isDarkMode, customStyles)
                        }
                      >
                        {discountPercent > 0 && (
                        ...
                        <div style={customStyles.imageContainer(isMobile)}>
                          <LazyLoadImage
                            ...
                            onError={(e) =>
                              (e.target.src =
                                "https://placehold.co/300x380/fdf6f6/800020?text=JEWELLERY")
                            }
                          />
                        </div>
                        <Card.Body className="text-start p-3 d-flex flex-column">
                          <p
                            ...
                            className="jewellery-brand-text"
                          >
                            {product.brand}
                          </p>
                          <Card.Title
                            style={customStyles.title}
                            className="text-truncate jewellery-card-title theme-text"
                          >
                            {product.name}
                          </Card.Title>
                          <div className="d-flex align-items-center mt-auto">
                            ...
                            {product.originalPrice > product.price && (
                              <span
                                ...
                                className="jewellery-original-price theme-text-secondary"
                              >
                                ₹{product.originalPrice}
                              </span>
                            )}
                          ...
                          <Button
                            ...
                            className="jewellery-view-deal-btn theme-button"
                            onMouseEnter={(e) =>
                              handleViewDealMouseEnter(e, isDarkMode, customStyles)
                            }
                            onMouseLeave={(e) =>
            ...
            <div className="text-center mt-5">
              <Link to="/jewellery">
                <Button
                  ...
                  className="jewellery-explore-btn theme-button"
                  onMouseEnter={(e) =>
                    handleExploreMouseEnter(e, isDarkMode, customStyles)
                  }
                  onMouseLeave={(e) =>
