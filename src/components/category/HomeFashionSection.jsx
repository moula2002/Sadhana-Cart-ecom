...
const ACCENT_COLOR_DARK = "#e83e8c"; // Brighter pink for dark mode
const SALE_COLOR = "#c71585";    // Medium Violet Red
const SALE_COLOR_DARK = "#da2d8d"; // Brighter for dark mode
...
const getCustomStyles = (isDarkMode) => ({
  ...
  productCard: {
    ...
    boxShadow: isDarkMode ? 
      ...
      "0 10px 25px rgba(214, 51, 132, 0.05)",
  ...
  brandText: {
    fontSize: "0.7rem",
    fontWeight: "700",
    color: isDarkMode ? "#c8a2c8" : "#a86d8d",
    marginBottom: "4px",
    letterSpacing: "1px",
  ...
  headerUnderline: {
    ...
    width: "120px",
    height: "15px",
    backgroundColor: isDarkMode ? "rgba(232, 62, 140, 0.2)" : "rgba(214, 51, 132, 0.1)",
    zIndex: -1,
    borderRadius: "4px",
  },
  viewDealButton: {
  ...
  exploreButton: {
    ...
    padding: "0.8rem 3rem",
    boxShadow: isDarkMode ? 
      "0 10px 30px rgba(232, 62, 140, 0.3)" : 
  ...
  exploreButtonHover: (isDarkMode) => ({
    ...
    boxShadow: isDarkMode ? 
      `0 10px 25px rgba(232, 62, 140, 0.6)` : 
  ...
  pinkWatermark: {
    ...
    fontSize: "12rem",
    fontWeight: "900",
    color: isDarkMode ? "rgba(232, 62, 140, 0.05)" : "rgba(214, 51, 132, 0.03)",
    userSelect: "none",
    pointerEvents: "none"
  },
  subtitle: {
...
const handleCardMouseEnter = (e, isDarkMode) => {
  ...
  e.currentTarget.style.boxShadow = isDarkMode ? 
    ...
    "0 25px 50px rgba(214, 51, 132, 0.12)";
...
function HomeFashionSection() {
  ...
  return (
    <Container 
      fluid 
      className="category-section fashion" 
      style={{ 
        background: isDarkMode ? DARK_BG_GRADIENT : PINK_BG_GRADIENT, 
        padding: "70px 0",
        transition: "background 0.3s ease"
      }}
    >
      <Container style={customStyles.sectionContainer} className="fashion-section-container">
                  ...
                  <Col key={product.id}>
                    <Link to={`/product/${product.id}`} className="text-decoration-none d-block h-100">
                      <Card
                        ...
                        className="fashion-card theme-card"
                      ...
                      >
                        ...
                        <Card.Body className="text-start p-3 d-flex flex-column">
                          <p style={customStyles.brandText} className="fashion-brand-text">
                            {product.brand}
                          </p>
                          <Card.Title 
                            style={customStyles.title} 
                            className="text-truncate fashion-card-title theme-text"
                          >
                            {product.name}
                          </Card.Title>
                          <div className="d-flex align-items-center mt-auto">
                            <span style={customStyles.price} className="fashion-price">
                              ₹{product.price}
                            </span>
                            {product.originalPrice > product.price && (
                              <span style={customStyles.originalPrice} className="fashion-original-price theme-text-secondary">
                          ...
                          <Button
                            ...
                            className="fashion-view-deal-btn theme-button"
            ...
            <div className="text-center mt-5">
              <Link to="/fashion">
                <Button
                  ...
                  className="fashion-explore-btn theme-button"
